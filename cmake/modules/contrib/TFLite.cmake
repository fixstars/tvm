...
if(NOT USE_TFLITE STREQUAL "OFF")
  ...
  if (NOT USE_EDGETPU STREQUAL "OFF")
    ...
    include_directories(${USE_EDGETPU}/include)
    find_library(EDGETPU_CONTRIB_LIB libedgetpu.so ${USE_EDGETPU})
    list(APPEND TVM_RUNTIME_LINKER_LIBS ${EDGETPU_CONTRIB_LIB})
  endif()
